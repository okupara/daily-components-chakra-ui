/* just copied from "packages/popper/src/popper.utils.ts"
   from chakra-ui because this module is not exported */
...
export const toTransformOrigin = (placement: Placement) => transformEnum[placement]
